...
@Setter
@NoArgsConstructor
public class Dependence extends Connection{
    public Dependence(String name, Node parent, Interclass from, Interclass to, Point start, Point end) {
        super(name, parent, from, to, start, end, "dependence");
    }
}
